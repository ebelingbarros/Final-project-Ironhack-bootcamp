...
The second part of the statistical analysis consisted in answering the question of what can be done about the scenario sketched in part one, where it was seen that the average size of the investments and of the average size of the physical guarantee tends to be small, thus threatening future security of supply in the future and potentially becoming a macroeconomic burden. The counterveiling factor to minimize the chances of this event materializing is to **create the conditions to increasing the number of winning bids in a given auction**. Even though these would very likely have a **low** investments and **very low** physical guarantee profile, when added up they also may permit to accomplish the goal of safeguarding security of supply. However, it was also predicted that there is a chance of a next hypothetical auction having a low number of winning bids, a scenario that would treaten security of supply.  What ,then, can be done to minimize the chance of the latter scenario from materializing? To analyse this question, a machine learning regression analysis is employed, using three different takes is employed: linear, polynomial and Random forest regression.
